                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <Typography 
                                            ...
                                            sx={{marginTop: '20px'}}
                                        >
                                            <strong>Tus preferencias globales</strong>
                                        </Typography>
                                        <Typography 
                                            fontSize={{
                                                lg: 15,
                                            ...
                                            sx={{marginTop: '20px'}}
                                        >
                                            Seleccioná tus preferencias generales para que tengas una mejor experiencia de usuario.
                                        </Typography>
                                    </Box>
                                </Paper> 
                            </Container>
