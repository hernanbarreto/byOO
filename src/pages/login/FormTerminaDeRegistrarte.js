...
function FormTerminaDeRegistrate(props) {
    ...
    const [valueInputNameFormRegistrate, setValueInputNameFormRegistrate] = useState(String(props.nombre) + String('/') + String(props.apellido));
...
export default FormTerminaDeRegistrate